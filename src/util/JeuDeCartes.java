 ...
 * Un jeu de carte contient 52 cartes. Chacune sera representée par un nombre entre 0 et 51.
 * 
...
public class JeuDeCartes {
    ...
    /**
     * Initialise le processus aléatoire. Un même germe va générer les mêmes cartes.
     * @param germe pour initialiser le processus aléatoire
     */
    ...
    /**
     * Retourne la première carte sur le dessus du paquet.
     * La carte est retirée du paquet.
     * @return carte pigée (nombre entre 0 et NOMBRE_CARTES - 1)
     */
    ...
    /**
      * Détermine si une carte est valide ou non.
    ...
    /**
     * Retourne un nombre aléatoire uniformement distribué entre a et b inclusivement.
     * antécédent : a <= b (les nombres générés ne seront plus uniformes sinon)
    ...
    private static Random generateur = new Random ( 0 ) ;  // générateur de nombres aléatoires.  Doit être créé (avec initialiserJeuDeCartes par exemple.)
